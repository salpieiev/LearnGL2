...
void RenderingEngine::SetPngPOTTexture(const string &name) const
{
...
void RenderingEngine::SetPngNPOTTexture(const string &name) const
{
    TextureDescription description = m_resourceManager->LoadPngNPOTImage(name);

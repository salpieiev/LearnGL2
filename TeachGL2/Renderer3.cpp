...
#include "Renderer3.h"
#include "Shaders/TextureShader.vsh"
#include "Shaders/TextureShader.fsh"
...
Renderer3::Renderer3(int width, int height): RenderingEngine(width, height)
{
    ...
    m_program = BuildProgram(TextureVertexShader, TextureFragmentShader);
...
void Renderer3::OnFingerDown(ivec2 location)
{
    m_rotator->Start(location);
}

void Renderer3::OnFingerMove(ivec2 oldLocation, ivec2 newLocation)
{
    m_rotator->Move(newLocation);
}

void Renderer3::OnFingerUp(ivec2 location)
{
